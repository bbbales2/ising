...
runMC = function(path) {
  system("(cd /home/bbales2/casm/cubic_3d; rm -rf conditions.* results.json; /home/bbales2/local/casm/bin/casm monte -s monte.json)")
}
...
#getResults("/home/bbales2/casm/cubic_3d/")
