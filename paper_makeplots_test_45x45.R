...
paths = c("/home/bbales2/ising/paper_outputs/test1.2.dat",
          "/home/bbales2/ising/paper_outputs/test12.dat",
          "/home/bbales2/ising/paper_outputs/test2.2.dat",
          "/home/bbales2/ising/paper_outputs/test13.dat",
          "/home/bbales2/ising/paper_outputs/test3.2.dat",
          "/home/bbales2/ising/paper_outputs/test14.dat")
...
whichReplace = list("test1.2.dat" = "test1.30x30",
                    "test12.dat" = "test1.45x45",
                    "test2.2.dat" = "test2.30x30",
                    "test13.dat" = "test2.45x45",
                    "test3.2.dat" = "test3.30x30",
                    "test14.dat" = "test3.45x45",
                    "TRUTH" = "TRUTH")
data$opts2 %>%
